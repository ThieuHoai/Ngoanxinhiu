...
class ZookeepersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zookeeper" do
    assert_difference("Zookeeper.count") do
      post zookeepers_url, params: { zookeeper: { date_of_birth: @zookeeper.date_of_birth, name: @zookeeper.name } }
    end
  ...
  test "should update zookeeper" do
    patch zookeeper_url(@zookeeper), params: { zookeeper: { date_of_birth: @zookeeper.date_of_birth, name: @zookeeper.name } }
