...
class AnimalPlacementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create animal_placement" do
    assert_difference("AnimalPlacement.count") do
      post animal_placements_url, params: { animal_placement: { location: @animal_placement.location } }
    end
  ...
  test "should update animal_placement" do
    patch animal_placement_url(@animal_placement), params: { animal_placement: { location: @animal_placement.location } }
