...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference("Visitor.count") do
      post visitors_url, params: { visitor: { Phone_number: @visitor.Phone_number, address: @visitor.address, gender: @visitor.gender, name: @visitor.name } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { Phone_number: @visitor.Phone_number, address: @visitor.address, gender: @visitor.gender, name: @visitor.name } }
